...
const TodoModule: React.FC<TodoModuleProps> = ({
  ...
  // Use the integration hook for handling calendar-todo integration
  const {
  ...
  // Handle drops from calendar events
  const handleDrop = (e: React.DragEvent) => {
    ...
    try {
      ...
      console.log("Todo module received drop data:", data);
      
      // Only handle drops from calendar
      if (data.source === "calendar-module") {
